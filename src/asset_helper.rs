...
pub async fn resolve_attachment_asset_name(
    asset_name: &str,
    ...
    (
        String,
        crate::api::client::RequestError<crate::api::types::asset::AssetGetError>,
    ),
> {
    ...
    match api_client
        ...
        .await
    {
        Ok(res) => Ok(format!(":{}:{}", res.entry.entry_id, last_relname)),
        Err(e) => {
            // Bail out
            Err((current_name, e))
        }
