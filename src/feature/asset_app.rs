...
pub async fn launch_browser(
        ...
        .await
    {
        ...
        let ws_localhost_addr = format!("localhost:{}", ws_addr.port());
        let fragment = if asset_prog_from_localhost {
            ...
            format!("#asset={}&ws=ws://{}", target_asset_name, ws_localhost_addr)
        } else {
            format!(
                "#asset={}&ws=ws://{}&token={}",
                target_asset_name, ws_localhost_addr, auth_token
            )
        };
